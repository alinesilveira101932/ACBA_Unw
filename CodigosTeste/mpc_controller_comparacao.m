...
function controller = mpc_controller_comparacao(A,B,N,Q,R,P,W,bo,Oq,nt,Sf,na,nx,nu,Su,bu,Tx,Tu,Oxbar,Oubar)
yalmip('clear');
...
for i = 1:N
    for j = 1:na
        ...
        % constraints = [constraints, Tu*qbar == 0]; % Forcando ubar = 0
    end
end
...
outputs = [X U {xbar} {ubar} {objective}];
